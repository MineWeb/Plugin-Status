	...
	public function after($event = array()) {}
        ...
        public $servers = [
            'status-iconurl' => array('type' => 'string', 'null' => false, 'default' => 'https://pixelads.fr/img/cover/1497104509.png', 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
						'status-motd' => array('type' => 'text', 'null' => false, 'default' => 'Motd default value', 'collate' => 'latin1_swedish_ci', 'charset' => 'latin1'),
						'status-isShowIp' => array('type' => 'integer', 'null' => false, 'default' => '1', 'unsigned' => false),
